    ...
    if (loading) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-muted/30 p-6">
                <div className="h-12 w-12 rounded-2xl flex items-center justify-center bg-primary text-primary-foreground mb-4">
    ...
    if (submitted) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-muted/30 p-6 text-center">
                ...
                >
                    <div className="h-20 w-20 rounded-3xl flex items-center justify-center mx-auto mb-6 bg-green-500">
                ...
                <div className="bg-background rounded-2xl shadow-sm border overflow-hidden">
                    ...
                    <div className="p-8">
                        <div className="flex items-center gap-4 mb-4">
                            <div className="h-12 w-12 rounded-2xl flex items-center justify-center bg-primary text-primary-foreground">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            className="rounded-xl h-12 border-muted hover:border-primary/50 focus:border-primary transition-colors"
                                                ...
                                                <div className="flex flex-wrap gap-4 justify-between items-center py-4">
                                                    {[1, 2, 3, 4, 5].map((num) => (
                                                        <button
                                                            ...
                                                            className={`h-16 w-16 rounded-2xl border-2 flex items-center justify-center text-xl font-bold transition-all ${answers[q.id] === String(num)
                    ...
                    <div className="pt-6 pb-20">
                        <Button
                            type="submit"
                            disabled={submitting}
                            className="w-full h-16 rounded-2xl text-xl font-black shadow-xl transition-all active:scale-[0.98]"
                        >
                            {submitting ? (
