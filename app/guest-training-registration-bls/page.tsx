...
export default function BLSRegistrationForm() {
                    ...
                    <CardContent className="p-8">
                        ...
                        <div className="mt-6 rounded-lg border bg-muted/20 p-3 text-xs text-muted-foreground space-y-3">
                            ...
                            <div className="flex items-start gap-3 rounded-md border bg-background p-3">
                                <Checkbox
                                    id="privacy-policy-agreement-bls"
                                ...
                                />
                                <Label htmlFor="privacy-policy-agreement-bls" className="cursor-pointer text-xs leading-relaxed text-foreground font-medium">
